...
**FINAL STATUS**: Scenario 13 v2 confirms that the agent **does** pivot to info collection after haggling, although simulation turn limits may prevent full closure.
